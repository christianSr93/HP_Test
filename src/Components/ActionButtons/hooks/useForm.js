...
const useForm = (props) => {
    ...
    const handleSubmit = async(e) =>{
        ...
        const data = {name, dateOfBirth: birthday, eyeColour:eyeColor, hairColour: hairColor, gender, hogwartsStudent: position === 'estudiante' ? true:false, hogwartsStaff:position === 'staff' ? true:false , image: save.data.url, alive:true}
